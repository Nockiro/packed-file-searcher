namespace PackedFileSearcher
{
    partial class FrmSettings
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.cb_useWholeFilePathForName.Size = new System.Drawing.Size(613, 30);
            this.cb_useWholeFilePathForName.TabIndex = 0;
            this.cb_useWholeFilePathForName.Text = "On file extraction, use the whole package path as prefix? (Only do this if you ha" +
    "ve multiple files with the same folder structure)\r\nExample: images.zip_garden_fl" +
    "owers_flower1.jpg\r\n";
